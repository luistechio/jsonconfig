...
def from_json_file(filename, **from_json_kwargs):
    try:
        return box.box._from_json(filename=filename, **from_json_kwargs)
...
def to_json_file(data, filename, **to_json_kwargs):
    try:
        return box.box._to_json(data, filename=filename, **to_json_kwargs)
...
def from_json(data, **from_json_kwargs):
    try:
        return box.box._from_json(data, **from_json_kwargs)
